function score = score_stack_ours(v_repeller, ...
                             v_wide1, ...
                             v_narrow1, ...
                             v_wide2, ...
                             v_narrow2, ...
    ...
    voltages = set_voltage_at_time(2, v_repeller, turn_on_time, step_times, voltages);
	voltages = set_voltage_at_time(3,    v_wide1,    0.0, step_times, voltages);
    voltages = set_voltage_at_time(4,  v_narrow1,    0.0, step_times, voltages);
    voltages = set_voltage_at_time(5,    v_wide2,    0.0, step_times, voltages);
