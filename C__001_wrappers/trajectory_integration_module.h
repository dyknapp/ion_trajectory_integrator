...
void integrate_trajectory_lite (const double *xx, const double *yy, const double *zz, const double *vxx, const double *vyy, const double *vzz, const double *potential_maps, const double *voltages, const double *step_times_in, const int *time_steps, const int *dimensions, const int *is_electrode, const int *n_electrodes, const double *m, const double *q, const double *din, const double *maxdist, const double *maxt, const double *data_t_interval, int *out_length, double *x_traj, double *y_traj, double *z_traj, double *ts, double *its, double *recorded);
