...
void nbody4 (const int *particles, const double *positions, const double *velocities, const double *ms_in, const double *qs_in, const double *omega_in, const double *depth_in, const double *r, const double *max_t, const double *max_dist, const double *record_step_in, const double *burst_time_in, double *trajectory, double *times, int *its, int *recorded);
