...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
     ...
     // &                        x_traj, y_traj, ts, its)
      ...
      // INPUTS
      mxDouble *xxs            = mxGetDoubles(prhs[0] );
      mxDouble *yys            = mxGetDoubles(prhs[1] );
      mxDouble *vxxs           = mxGetDoubles(prhs[2] );
      mxDouble *vyys           = mxGetDoubles(prhs[3] );
      ...
      mxDouble *ms             = mxGetDoubles(prhs[8] );
      mxDouble *qs             = mxGetDoubles(prhs[9] );
